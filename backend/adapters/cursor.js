 ...
 * Cursor IDE Adapter
 *
 * Cursor uses Cmd+L to open the chat panel and Cmd+V to paste.
 * App identifier: "Cursor" (or "com.todesktop.230313mzl4w4u92")
 */
...
class CursorAdapter extends BaseAdapter {
  ...
  getChatFocusShortcut() {
    // Cmd+L opens/focuses the Cursor chat panel
  ...
  async isRunning() {
    return new Promise((resolve) => {
      exec(
        `osascript -e 'tell application "System Events" to (name of processes) contains "Cursor"'`,
        (err, stdout) => {
